...
Public Class Wrkassignment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Estate_Management_Final.Wrkassignment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWrkassignment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Wrkassignment = New Wrkassignment
        rpt.Site = Me.Site
        Return rpt
    End Function
