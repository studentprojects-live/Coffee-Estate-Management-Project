...
Public Class workinvestments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Estate_Management_Final.workinvestments.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_wyear() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedworkinvestments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As workinvestments = New workinvestments
        rpt.Site = Me.Site
        Return rpt
    End Function
